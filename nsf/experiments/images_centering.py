...
def create_transform_step(num_channels,
    ...
    if use_resnet:
        ...
        #     raise ValueError()
        def create_convnet(in_channels, out_channels):
            return ConvNet(in_channels, hidden_channels, out_channels, dropout=dropout_prob)
...
#                      use_resnet, num_res_blocks, resnet_batchnorm, dropout_prob,
#                      ):
def create_transform(c, h, w, train_mean, val_mean,
                     levels, hidden_channels, steps_per_level, alpha, num_bits, preprocessing,
                     multi_scale,
                     actnorm, coupling_layer_type, spline_params,
                     use_resnet, num_res_blocks, resnet_batchnorm, dropout_prob,
...
def create_flow(c, h, w,
    ...
    train_transform, val_transform, transform = create_transform(c, h, w, train_mean, val_mean)
