    ...
    if multi_scale:
        ...
        for level, level_hidden_channels in zip(range(levels), hidden_channels):
            ...
            transform_level = transforms.CompositeTransform(
                [squeeze_transform]
                + [create_transform_step(c, level_hidden_channels, actnorm, coupling_layer_type, spline_params,
                     use_resnet, num_res_blocks, resnet_batchnorm, dropout_prob) for _ in range(steps_per_level)]
